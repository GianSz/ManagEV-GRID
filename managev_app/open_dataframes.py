#En este archivo tenemos un conjunto de funciones usadas para hacer consultas de datos, ya sea 
#de la base de datos o directamente de los archivos csv y json que se encuentran en esta carpeta
