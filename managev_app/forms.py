#En este archivo se establecen todos los formularios que tiene la aplicación. 
#Más específicamente los formularios de login, registro de cuenta, registro de vehículos y un formluario de fechas usado en el dashboard.
