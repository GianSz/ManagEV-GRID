#En este ardchivo tenemos los endpoint de la aplicación con la correspondiente función encargada de atender ese endpoint.
#Si conoce sobre Django este archivo se puede asemejar a una mezcla entre urls.py y views.py
